...
export default function Landing() {
    ...
    return (
        <div
            className={`leading-normal tracking-normal text-white ${contextValue.isDark ? "gradientDark" : "gradient"
            ...
            <div>
                    ...
                    <div className='container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center'>
                        <div className='flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left'>
                            <h1 className='my-4 text-5xl font-bold leading-tight'>
                                Get your business recognised by locals!
                            </h1>
                            <p className='leading-normal text-2xl mb-8'>
                                Collect NFTs by shopping with local shops and vendors and posting a selfie with them.
                            </p>
                            <div className='w-full flex-grow lg:flex lg:items-center lg:w-auto mt-2 lg:mt-0  lg:bg-transparent text-black p-4 lg:p-0 z-20'>
                                <button
                                    ...
                                    className={`mx-auto lg:mx-0 hover:underline ${contextValue.isDark ? "darkBtn" : "lightBtn"
                        ...
                        <div className='w-full md:w-3/5 py-6 text-center'>
                            <Image className='w-full md:w-3/5 mx-auto mb-10' src={landingIllustration} />
                        </div>
                    </div>
                </div>
                ...
                <section
                    className={`${contextValue.isDark ? "darkBg lightText" : "bg-white darkText"
                        } py-8`}>
                ...
                <footer
                    className={`text-center lg:text-left ${contextValue.isDark
                        ? "bg-[#4b3149] lightText"
                        : "bg-gray-100 text-gray-600"
                        } `}>
                    {/* <div
                        className={`flex justify-center items-center lg:justify-between p-6 border-b ${contextValue.isDark ? "border-[#26365a]" : "border-gray-400"
                            }`}>
                        ...
                        <div className='flex justify-center'>
                            ...
                            <a
                                ...
                                target={"_blank"}
                                rel='noreferrer'
                                className={`mr-6 ${contextValue.isDark
                                    ? "bg-[#141e33] lightText"
                                    : "bg-gray-100 text-gray-600"
                                    }`}>
                                <svg
          ...
          '>
                                ...
                                <p>
                                    Vyapaar Link is a Decentralized Open Source growth platform for small scale businesses where shop owners can get reach and earn revenue to selfie NFT sales and crypto tippings through DeSo.
                                </p>
                            </div>
