...
export default function Navbar(props) {
    ...
    return (
        <>
            <nav
                id='header'
                className={`fixed transition duration-300 bg-white ${props.gradient
                    ? contextValue.isDark
                        ? "gradientDark"
                        : "gradient text-white"
                    : contextValue.isDark
                ...
                <>
                    <div className='w-full container mx-auto md:grid md:grid-cols-3 flex flex-wrap items-center justify-between mt-0 py-2'>

                        <div
                            className={`toggleColour ${props.gradient
                                ? "text-white"
                                : contextValue.isDark
                                    ? "text-white"
                                    : "text-black"
                            ...
                            <Link href='/'>Vyapaar Link</Link>


                        </div>
                        {/* <div className=' justify-center md:flex items-center hidden md:visible '>
                            <input
                                className={`${contextValue.isDark ? "thirdDark text-gray-100" : "bg-gray-100 text-gray-900"
                            ...
                            <button
                                className={`${contextValue.isDark ? "darkBtn" : "lightBtn"
                        ...
                        <div
                            ...
                            {props.noCreate ? (
                                ...
                                <button
                                    ...
                                    className={`mx-auto hover:underline font-bold rounded-full mt-0 py-4 px-8 shadow ${contextValue.isDark ? "darkBtn" : "lightBtn"
                            ...
                            {/* <button
                                className={`mx-2 fas px-3 py-2 rounded-full outline-none active:outline-none focus:outline-none border-none active:border-none focus:border-none fa-${contextValue.isDark
                    ...
                    <hr
                        className={`border-b ${contextValue.isDark ? "border-blue-200" : "border-gray-100"
