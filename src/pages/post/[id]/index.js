                    ...
                    <div
                        ...
                        <div
                            ...
                            <div>
                                <div className='post-head'>
                                    <div className=' flex items-center space-x-2 px-10'>
                                        ...
                                        <div className='flex flex-col space-y-1'>
                                            <p
                                                className={` ${contextValue.isDark ? "lightText" : ""
                                            ...
                                            <div
                                                className={` ${contextValue.isDark ? "leastLightText" : ""
                                                    } post-date text-sm`}>
                                                {postDate}
                                            </div>
                                        </div>
                                ...
                                <div
                                    className={`${contextValue.isDark ? "dakrBg" : ""
                                    ...
                                    <div className='leftContainer lg:px-10 xm:px-2 '>
                                        ...
                                        {loadingContent ? (
                                            ...
                                            <ReactMarkdown
                                                className={` ${contextValue.isDark ? "lessLightText" : ""
                                                    } post-content text-lg font  break-words  ${contextValue.isDark ? "unresetDark" : "unresetLight"
                                                    } unreset`}
                                    ...
                                    <div
                                        className={`${contextValue.isDark ? "darkBg lessLightText" : ""
                                        ...
                                        <div className='flex flex-col'>
                                            <div
                                                className={`${contextValue.isDark ? "darkContainer" : "bg-gray-100"
                                            ...
                                            <div
                                                ...
                                                <input
                                                    ...
                                                    className={`${contextValue.isDark ? "thirdDark" : "lighContainer"
